// Normalize raw metric values to a 0–100 score for the bar chart
        ...
        {chartData.map(item => (
          <div key={item.label} className="space-y-2">
            ...
            <div className="h-3 overflow-hidden rounded-full bg-(--panel)">
              <div
                className="h-full rounded-full bg-linear-to-r from-violet-500 via-cyan-400 to-sky-500 transition-all duration-700"
